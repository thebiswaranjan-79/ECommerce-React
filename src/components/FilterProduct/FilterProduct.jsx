    ...
    <div className="product-list-sidebar d-flex flex-column">
        ...
        <div id="categoryList">
            {/* Will be Populated by Js */}
             ...
             <a href="productList.html?category=electronics" class="d-flex text-decoration-none">Electronics</a>
             <a href="productList.html?category=jewelery" class="d-flex text-decoration-none">Jewellary</a>
             <a href="productList.html?category=men's clothing" class="d-flex text-decoration-none">Men's Clothing</a>
             <a href="productList.html?category=women's clothing" class="d-flex text-decoration-none">Women's Clothing</a> 
             <a href="productList.html?category=electronics" class="d-flex text-decoration-none">Gaming</a>
